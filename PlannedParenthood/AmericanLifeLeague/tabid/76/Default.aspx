...
<body id="Body">
    <noscript></noscript>
    <form name="Form" method="post" action="/PlannedParenthood/AmericanLifeLeague/tabid/76/Default.aspx" id="Form" enctype="multipart/form-data" style="height: 100%;">
<div>
...
<a id="dnn_dnnSEARCH_cmdSearch" class="Search" href="javascript:__doPostBack('dnn$dnnSEARCH$cmdSearch','')"><img src="/Portals/_default/Skins/skins/images/bs14srch.png" align="absMiddle" border="0"></a></td>
      ...
      <tr>
        ...
        <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td id="dnn_ContentPane" width="100%" valign="top" class="ContentPane"><a name="387"></a>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="100%" background="/Portals/_default/Containers/containers/Images/Contaier002_r1_c2.jpg" style="background-position:bottom; background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td nowrap><span id="dnn_ctr387_dnnTITLE_lblTitle" class="stylecontainertitle1">American Life League</span>
  ...
  <tr>
    <td id="dnn_ctr387_ContentPane" width="100%" valign="top" class="DNNAlignleft"><!-- Start_Module_387 --><div id="dnn_ctr387_ModuleContent">
	<div id="dnn_ctr387_HtmlModule_HtmlModule_lblContent" class="Normal">
	<p align="center"><a href="http://www.all.org"><img width="631" height="131" alt="" src="/Portals/0/all.JPG" /></a></p>
<p align="center"><hr />
</p>
</div>
<!-- End_Module_387 -->
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%" nowrap></td>
        <td nowrap></td>
        <td nowrap><a id="dnn_ctr387_dnnACTIONBUTTON3_ico3" href="javascript:__doPostBack('dnn$ctr387$dnnACTIONBUTTON3$ico3','')"><img title="Print" src="/images/action_print.gif" alt="Print" style="border-width:0px;" /></a>&nbsp;&nbsp;</td>
        <td nowrap></td>
      </tr>
    </table></td>
  </tr>
