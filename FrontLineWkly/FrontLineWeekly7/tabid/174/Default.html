...
<body id="Body">
    <noscript></noscript>
    <form name="Form" method="post" action="/FrontLineWkly/FrontLineWeekly7/tabid/174/Default.aspx" id="Form" enctype="multipart/form-data" style="height: 100%;">
<div>
...
<!-- End_Module_373 -->
  ...
  <tr>
    <td width="100%" height="5"></td>
          ...
          <tr>
            <td id="dnn_ContentPane" width="100%" valign="top" class="ContentPane"><a name="488"></a>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="100%" background="/Portals/_default/Containers/containers/Images/Contaier002_r1_c2.jpg" style="background-position:bottom; background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td nowrap><span id="dnn_ctr488_dnnTITLE_lblTitle" class="stylecontainertitle1">Front Line Weekly 7</span>
  ...
  <tr>
    <td id="dnn_ctr488_ContentPane" width="100%" valign="top" class="DNNAlignleft"><!-- Start_Module_488 --><div id="dnn_ctr488_ModuleContent">
	<div id="dnn_ctr488_HtmlModule_HtmlModule_lblContent" class="Normal">
	<p>&lt;<a href="/LinkClick.aspx?link=146&amp;tabid=174">Previous</a> Page</p>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%" nowrap></td>
        <td nowrap></td>
        <td nowrap><a id="dnn_ctr488_dnnACTIONBUTTON3_ico3" href="javascript:__doPostBack('dnn$ctr488$dnnACTIONBUTTON3$ico3','')"><img title="Print" src="/images/action_print.gif" alt="Print" style="border-width:0px;" /></a>&nbsp;&nbsp;</td>
        <td nowrap></td>
      </tr>
    </table></td>
  </tr>
